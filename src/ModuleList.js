...
export const ModuleList = (props) => {
  ...
  return (
    <div className="p-grid">
      ...
      .filter((module) => !selectedFilters.maker || selectedFilters.maker.length === 0 || selectedFilters.maker.indexOf(module.makerId) >= 0)
      .map(module => {
        return (
            ...
            <Card>
              <div className="p-grid" style={{height: "350px"}}>
                <div className="p-col-6">
                  <img style={{maxWidth: "100%", maxHeight: "300px", textAlign:'center'}} src={module.imageLink} alt={`${module.name} - ${module.description}`} />
                </div>
